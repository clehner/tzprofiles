...
export const newDisplay = (ct: ClaimType): ClaimUIAssets => {
  switch (ct) {
    ...
    case 'ethereum': 
      return {
        description: 'This process is used to show ownership of a specific Ethereum wallet by signing a statement containing your Tezos wallet with MetaMask',
        display: 'Ethereum Wallet Ownership',
        icon: EthereumIcon,
        route: '/ethereum',
        routeDescription: 'Ethereum Wallet Ownership',
        // TODO: Is this a good description of the proof?
        proof: 'Signed Document',
